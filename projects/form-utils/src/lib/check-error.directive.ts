import { Directive, HostBinding, AfterViewInit, ElementRef } from '@angular/core';
import { NgForm } from '@angular/forms';

@Directive({
  selector: '[checkError]'
})
export class CheckErrorDirective implements AfterViewInit {
  @HostBinding() checkError: string;
  @HostBinding() form: NgForm;
  constructor(private elementRef: ElementRef) { }
  ngAfterViewInit() {
    this.getErrors(this.form, this.checkError);
  }
  getErrors(ntForm: NgForm, str: string) {
